package br.com.loja.jsf;

import br.com.loja.entity.Cliente;
import br.com.loja.jsf.util.JsfUtil;
import br.com.loja.jsf.util.PaginationHelper;
import br.com.loja.jpa.ClienteJpaController;
...
public class ClienteController implements Serializable {
    ...
    private ClienteJpaController getJpaController() {
        if (jpaController == null) {
            jpaController = new ClienteJpaController(utx, emf);
        }
